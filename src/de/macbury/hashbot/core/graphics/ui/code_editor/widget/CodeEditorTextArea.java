package de.macbury.hashbot.core.graphics.ui.code_editor.widget;
...
import de.macbury.hashbot.core.graphics.ui.code_editor.js.JavaScriptScanner;
...
public class CodeEditorTextArea extends WidgetGroup {
  ...
  private void initializeKeyboard() {
    ...
    inputListener = new ClickListener() {
      ...
      public void exit(InputEvent event, float x, float y, int pointer, Actor toActor) {
        //if (toActor != CodeEditorTextArea.this)
          HashBot.ui.normalCursor();
      }
    };
  ...
  public void act(float delta) {
    ...
    if (!isFocused()) {
      //TODO: FIX!! BotLogic.skin.setPointerCursor();
    }
  }
