...
public class MenuScreen implements Screen {
  ...
  public MenuScreen() {
    ...
    stage.table.row().expand();
    stage.table.add().colspan(2);
    stage.table.row();
    stage.table.add().expandX();
    stage.table.add(HashBot.ui.textButton(HashBot.i18n.t("menu_screen.continue"))).padBottom(10).padRight(10).width(200);
    stage.table.row();
    stage.table.add().expandX();
    stage.table.add(HashBot.ui.textButton(HashBot.i18n.t("menu_screen.new_game"))).padBottom(10).padRight(10).width(200);
    stage.table.row();
    stage.table.add().expandX();
    stage.table.add(HashBot.ui.textButton(HashBot.i18n.t("menu_screen.settings"))).padBottom(10).padRight(10).width(200);
    stage.table.row();
    stage.table.add().expandX();
    stage.table.add(HashBot.ui.textButton(HashBot.i18n.t("menu_screen.map_editor"))).padBottom(10).padRight(10).width(200);
    stage.table.row();
    stage.table.add().expandX();
    stage.table.add(HashBot.ui.textButton(HashBot.i18n.t("menu_screen.exit"))).width(200).padBottom(10).padRight(10);
  }
